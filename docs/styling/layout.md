...
A `rx.section` component is often used for dividing the page into meaningful areas with semantic importance.

**When to use:** Use `rx.section` for grouping related content that forms a distinct part of your page layout, improving accessibility and SEO.
