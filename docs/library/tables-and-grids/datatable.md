...
If you want to [add, edit or remove data]({library.tables_and_grids.table.path}) in your app or deal with anything but static data then the [`rx.table`]({library.tables_and_grids.table.path}) might be a better fit for your use case.
