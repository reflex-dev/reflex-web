...
```python
info_callout = rx.callout(
    "Despite being an enterprise package, free users can use the components from this package. A badge 'Built with Reflex' will be shown in the bottom right corner of the app. For more information on the badge, visit Built with Reflex.",
    icon="info",
    color_scheme="blue",
    size="1",
)
    ...
    detail_cell_renderer_params={
        "detail_grid_options": {
            "column_defs": [
                ...
                dict(field="description", header_name="Description", width=350),
                dict(field="cloud_tier", header_name="Cloud Tier", width=120),
                dict(field="self_hosted_tier", header_name="Self-hosted Tier", width=140),
            ],
