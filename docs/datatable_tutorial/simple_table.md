...
```md alert info
#There is another [datatable component]({library.table.datatable.path}), which is only used for displaying data and does not support user interactivity or editing.
```
