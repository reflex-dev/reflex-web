...
If you are using a NoSQL database (e.g. MongoDB), you can still use Reflex by using the appropriate Python client library. In this case, Reflex will not provide any ORM features.
```
