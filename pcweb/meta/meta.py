...
meta_tags = [
    ...
    {"name": "keywords", "content": "reflex, python, web apps, framework, open source, frontend, backend, full stack"},
    {"name": "description", "content": "The open-source framework to build and deploy web apps using Python."},
    # Facebook Meta Tags
    {"property": "og:url", "content": "https://reflex.dev/"},
    {"property": "og:type", "content": "website"},
    {"property": "og:title", "content": "Reflex · Web apps in Pure Python"},
    {"property": "og:description", "content": "The open-source framework to build and deploy web apps using Python."},
    {"property": "og:image", "content": "https://reflex.dev/ogimage.jpg"},
    # Twitter Meta Tags
    ...
    {"name": "twitter:description", "content": "The open-source framework to build and deploy web apps using Python."},
    {"name": "twitter:image", "content": "https://reflex.dev/ogimage.jpg"},
