...
from .state import WebSidebarState, SidebarItem
...
def sidebar_category(name, icon, color, index):
    return rx.flex(
            ...
            on_click=lambda: WebSidebarState.set_sidebar_index(index),
            background=rx.cond(
                WebSidebarState.sidebar_index == index,
                "#F5EFFE",
                "transparent",
            ),
            align_items="center",
