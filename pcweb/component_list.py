...
# Graphing components.
graphing_list = [[pc.Chart], [pc.Area], [pc.BoxPlot], [pc.Candlestick], [pc.ErrorBar], [pc.Line],[pc.Bar], [pc.Group], [pc.Histogram], [pc.Pie],[pc.Polar], [pc.Scatter],[pc.Voronoi], [pc.Plotly]]
