            ...
            rx.el.div(
                rx.el.div(
                    solutions_column(
                        "Who's It For",
                        [
                            ("Executives", "LocationUser01Icon", use_cases_page.path),
                    ...
                    solutions_column(
                        "Industries",
                        [
                            ("Enterprise", "OfficeIcon", use_cases_page.path),
                            ("Finance", "Wallet05Icon", finance_use_case_page.path),
                            ("Healthcare", "HealthIcon", healthcare_use_case_page.path),
                            (
                                "Consulting",
                                "DocumentValidationIcon",
                                consulting_use_case_page.path,
                            ),
                            (
                                "Government",
                                "BankIcon",
                                government_use_case_page.path,
                            ),
                        ],
                    ),
        ...
        rx.el.div(
            rx.el.div(
                solutions_column(
                    "Developers",
                    [
                        ("Templates", "Layout02Icon", gallery.path),
                        (
                            "Integrations",
                            "PlugSocketIcon",
                            ai_builder.integrations.overview.path,
                        ),
