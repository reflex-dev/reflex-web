...
def docs_navbar() -> rx.Component:
    ...
    return rx.el.div(
        ...
        rx.el.header(
            ...
            class_name="w-full max-full h-[4.5rem] mx-auto flex flex-row items-center lg:px-16 px-6 backdrop-blur-[16px] shadow-[0_-2px_2px_1px_rgba(0,0,0,0.02),0_1px_1px_0_rgba(0,0,0,0.08),0_4px_8px_0_rgba(0,0,0,0.03),0_0_0_1px_#FFF_inset] dark:shadow-none dark:border-b dark:border-m-slate-10 bg-gradient-to-b from-[light-dark(#FFF,var(--m-slate-11))] to-[light-dark(var(--m-slate-1),var(--m-slate-12))]",
        ),
