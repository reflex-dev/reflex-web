        ...
        rx.el.form(
            rx.cond(
                ...
                rx.box(
                    ...
                    class_name="h-auto flex flex-row items-center gap-2 overflow-x-auto scrollbar-thin scrollbar-thumb-slate-4 scrollbar-track-transparent overflow-y-visible pt-4",
                ),
            ),
            rx.box(
                rx.box(
