    ...
    return rx.el.section(
        rx.box(
            rx.box(
                rx.el.h2(
                    "Secure by default",
                    class_name="text-slate-12 text-3xl font-semibold text-start",
                ),
                rx.el.h3(
                    "SOC 2 compliant with enterprise-grade security and flexible deployment options.",
                    class_name="text-slate-9 text-2xl font-semibold text-start",
                ),
                class_name="flex flex-col gap-2 col-span-2 p-10",
            ),
            security_badges(),
            class_name="grid grid-cols-3 divide-x divide-slate-4 w-full",
        ),
