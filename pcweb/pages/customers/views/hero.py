    ...
    return rx.el.section(
        rx.el.div(
            rx.el.div(
                ...
                class_name="flex flex-col gap-6 lg:max-w-[21rem] lg:sticky lg:mt-[5rem] lg:top-[9rem] lg:self-start max-lg:self-center max-lg:items-center max-lg:text-center",
            ),
            customer_cards(),
            class_name="flex lg:flex-row flex-col max-lg:gap-6 max-w-(--docs-layout-max-width) mx-auto relative pb-24 max-lg:px-6",
        ),
