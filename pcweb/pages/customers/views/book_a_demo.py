...
def book_a_demo() -> rx.Component:
    return rx.el.section(
        rx.el.div(
            ...
            rx.el.div(
                demo_form(),
                class_name="relative bg-white/96 dark:bg-m-slate-11 rounded-xl dark:border dark:border-m-slate-9 shadow-[0_0_0_1px_rgba(0,_0,_0,_0.12)_inset,_0_12px_24px_0_rgba(0,0,0,0.08),_0_1px_1px_0_rgba(0,_0,_0,_0.01),_0_4px_8px_0_rgba(0,_0,_0,_0.03),_0_0_0_1px_#FFF_inset] dark:shadow-none w-full lg:mx-0 overflow-hidden ml-12 max-w-[42rem]",
            ),
            class_name="flex lg:flex-row lg:justify-between gap-12 flex-col max-lg:gap-6 max-w-(--docs-layout-max-width) mx-auto relative pb-24 max-lg:px-6",
        ),
