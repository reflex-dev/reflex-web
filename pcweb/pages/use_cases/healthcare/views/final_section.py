...
def final_section() -> rx.Component:
    return rx.el.section(
        rx.el.div(
            left_content(
                "Start Building Secure Healthcare Apps with Reflex",
                "Turn your workflows into AI-powered applications — fast, compliant, and fully customizable.",
            ),
            right_content(
                "Spin Up Your First Healthcare App",
