...
def compare():
    return common_compare(
        ...
        description="Other frameworks get you started fast, but Reflex lets you finish. Here's how Reflex compares to platforms like React, JavaScript, Django, and FastAPI.",
        top_left_title="Reflex",
        top_right_title="React, JavaScript, Django, FastAPI",
