...
def frontend_card(
    ...
    return rx.box(
        ...
        class_name=f"lg:col-span-{cols} col-span-1 h-96 rounded-[1.125rem] bg-slate-2 border border-slate-3 overflow-hidden relative shadow-large max-h-full pointer-events-none",
    )
