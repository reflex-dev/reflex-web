        ...
        rx.box(
            ...
            rx.form(
                rx.el.input(
                    ...
                    type="text",
                    required=True,
                    class_name="box-border border-slate-5 focus:border-violet-9 focus:border-1 bg-slate-4 p-[0.5rem_0.75rem] border rounded-[0.625rem] font-base text-slate-12 placeholder:text-slate-11 outline-none focus:outline-none w-full",
                ),
                icon_button(
                    "arrow-up",
                    variant="muted",
                    type="submit",
                    class_name="!bg-slate-5 !border-t-[rgba(255,255,255,0.05)] hover:!bg-slate-6 !text-slate-12",
                ),
