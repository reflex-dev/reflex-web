...
manual_titles = {
    ...
    "docs/custom_components/overview.md": "Custom Components Overview",
    "docs/custom_components/command_reference.md": "Custom Component CLI Reference",
    "docs/api_routes/overview.md": "API Routes Overview",
    ...
    "docs/wrapping_react/overview.md": "Wrapping React Overview",
    "docs/library/html/html.md": "HTML Elements",
    "docs/recipes_overview.md": "Recipes Overview",
