...
def state_reference():
    return pc.box(
        ...
        pc.code(s.get_name(), font_size=styles.H3_FONT_SIZE, font_weight=styles.DOC_SUBHEADING_FONT_WEIGHT),
        pc.divider(),
        ...
        pc.table(
            ...
            pc.tbody(
                *[
                    pc.tr(pc.td(pc.code(field["name"], font_weight=styles.BOLD_WEIGHT)), pc.td(field["description"]))
        ...
        pc.table(
            ...
            pc.tbody(
                *[
                    pc.tr(pc.td(pc.code(field["name"] + field["signature"], font_weight=styles.BOLD_WEIGHT)), pc.td(field["description"]))
