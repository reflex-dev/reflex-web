...
code_gls = """
rx.button("Copy value of 'key' in local storage to clipboard", on_click=rx.set_clipboard(rx.get_local_storage("key")))
"""
code_sls = """
rx.button(
    "Set 'key' in local storage", on_click=rx.set_local_storage("key", "value1")
)
"""
